...
test_that("modernized app features are present in app source", {
  ...
  expect_match(txt, "theme_widget_open", perl = TRUE)
  expect_match(txt, "theme_widget_close", perl = TRUE)
  expect_match(txt, "theme_widget_panel", perl = TRUE)
  expect_match(txt, "apply_theme", perl = TRUE)
  expect_match(txt, "tabPanel\\(\\s*\"About\"", perl = TRUE)
  expect_match(txt, "DownloadSign PDF", perl = TRUE)
  expect_match(txt, "DownloadSign HTML", perl = TRUE)
